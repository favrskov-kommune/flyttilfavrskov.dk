      ...
      if (videoData) {
        ...
        if (oembed !== 'null' && oembed !== null) {
          if (oembed.html.indexOf('iframe') > -1) {
            ...
            const newSrc = `${oldSrc}&autoplay=1&mute=1&playsinline=1&showinfo=0&autohide=1&background=1`; // We need to set this ourselves, otherwise we are not sure it is gonna play.
